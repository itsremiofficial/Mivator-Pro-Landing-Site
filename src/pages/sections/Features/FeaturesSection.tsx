...
import SphereRotation from './Mivator360';
        ...
        <div className="relative w-full max-w-screen-2xl mx-auto px-4 py-12">
          ...
          >
            ...
            {createCursorFollower(
              1,
              'relative z-[1] feature-card overflow-hidden inset-ring-3 inset-ring-primary/5 select-none md:col-span-3 lg:col-span-4 xl:col-span-3 bg-gradient-to-br from-light-200 to-light-500 dark:from-primary-1000 dark:to-primary-1100 rounded-3xl flex flex-col justify-between p-10 h-96',
              <div className="grid md:grid-cols-2 h-full">
                <div className="flex flex-col justify-between relative">
                  <div className="p-6 size-max bg-gradient-to-br from-light-200 to-light-500 dark:from-primary-1000 dark:to-primary/30 rounded-3xl">
                    <IconLayers className="size-16 text-primary" />
                  </div>

                  <div className="absolute z-[2] inset-0 pb-6 m-auto flex flex-col justify-end w-full">
                    <div className="text-7xl font-nippo font-extrabold leading-none text-light-200 dark:text-primary-600 overflow-hidden h-fit">
                    ...
                    <div className="w-[85%]">
                      <p className="dark:text-primary-800 font-base font-nippo font-bold">Explore a vast library of versatile commands, tailored for every need.</p>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col items-end">
                  ...
                  >
                    ...
                    <p className="absolute bottom-3 text-light-800 dark:text-primary-800 text-lg font-bold font-nippo">...and counting</p>
                  </div>
                  <a href="" className="w-full">
                    <button className="btn btn-primary dark:bg-primary-1000 text-primary border-none w-full rounded-3xl relative mt-4 px-7 py-4 gap-2 group/btn">
            ...
            {createCursorFollower(
              2,
              'col-span-1 p-6 bg-gradient-to-b from-light-200 to-light-500 dark:from-primary-1000 dark:to-primary-1100 rounded-4xl text-center relative z-[1] feature-card overflow-hidden inset-ring-3 inset-ring-primary/5 select-none flex flex-col items-center justify-center',
              <div>
                ...
                <div className="absolute z-[2] inset-0 m-auto flex flex-col items-center justify-end">
                  <div className="text-5xl font-nippo font-extrabold leading-none text-light-200 dark:text-primary-600 overflow-hidden h-fit uppercase">
                    <div className="relative overflow-hidden z-[1] w-full">
                      <div hoverstagger="title" className="relative inline-block w-full">
                        MS
                      </div>
                  ...
                  <p className="dark:text-primary-800 font-base font-nippo font-bold">Blazing-Fast Response</p>
                </div>
              </div>
            )}
            {/* 16 Categories */}
            {createCursorFollower(
              3,
              'col-span-1 p-6 bg-gradient-to-b from-light-200 to-light-500 dark:from-primary-1000 dark:to-primary-1100 rounded-4xl text-center relative z-[1] feature-card overflow-hidden inset-ring-3 inset-ring-primary/5 select-none',
              <div>
                <div className="flex justify-center">
                ...
                <div className="absolute z-[2] inset-0 m-auto flex flex-col items-center justify-end">
                  <div className="text-5xl font-nippo tracking-wide font-extrabold leading-none text-light-200 dark:text-primary-600 overflow-hidden h-fit">
                  ...
                  <p className="dark:text-primary-800 font-base font-nippo font-bold">Fully Customizable</p>
                </div>
              </div>
            )}
            {/* 16 Categories */}
            {createCursorFollower(
              4,
              'col-span-2 p-6 bg-gradient-to-b from-light-200 to-light-500 dark:from-primary-1000 dark:to-primary-1100 rounded-4xl text-center relative z-[1] feature-card overflow-hidden inset-ring-3 inset-ring-primary/5 select-none',
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-start justify-end gap-4">
                  <div className="text-3xl font-nippo tracking-wide font-extrabold leading-none text-light-200 dark:text-primary-600 overflow-hidden h-fit">
                    <div className="relative whitespace-nowrap overflow-hidden z-[1]">
                      <div hoverstagger="title" className="relative inline-block">
                  ...
                  <Balancer className="dark:text-primary-800 font-base font-nippo font-bold text-left">
                    {' '}
                    Enjoy your favorite tracks with a sleek, modern music player that’s packed with features.
                  </Balancer>
                </div>
                <div className="h-32 w-[380px] xl:h-44 xl:w-[520px] relative mx-auto">
                  <NowPlayingCard />
                </div>
              </div>
            )}
