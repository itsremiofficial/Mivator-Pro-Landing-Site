...
export const FeaturesSection: React.FC = React.memo(() => {
  ...
  return (
    <section className="min-h-screen py-20 px-4 w-full" key={'FeaturesSection'}>
      <div className="w-full mx-auto flex flex-col items-center group/bento">
        ...
        lg:grid-cols-4 
        xl:grid-cols-6 
        gap-6 auto-rows-[minmax(200px,auto)]"
        >
          {/* Over 500 Commands */}
          {createCursorFollower(
            1,
            'col-span-1 xl:col-span-4 bg-light-1100 dark:bg-primary-1100 rounded-4xl text-center relative z-[1] feature-card overflow-hidden inset-ring-3 inset-ring-primary/5 select-none',
            <div className="lg:opacity-60 group-hover/bento:opacity-100 transition-opacity duration-300">
              ...
              <div className="absolute z-[2] inset-0 m-auto flex flex-col items-center justify-end pb-6">
                <div className="text-6xl font-mont tracking-wide font-extrabold leading-none text-light-200 dark:text-primary-600 overflow-hidden h-fit uppercase">
          ...
          {createCursorFollower(
            2,
            'col-span-1 bg-light-1100 dark:bg-primary-1100 rounded-4xl text-center relative z-[1] feature-card overflow-hidden inset-ring-3 inset-ring-primary/5 select-none flex flex-col items-center justify-center',
            <div className="lg:opacity-60 group-hover/bento:opacity-100 transition-opacity duration-300">
          ...
          {createCursorFollower(
            3,
            'col-span-1 bg-light-1100 dark:bg-primary-1100 rounded-4xl text-center relative z-[1] feature-card overflow-hidden inset-ring-3 inset-ring-primary/5 select-none',
            <div className="lg:opacity-60 group-hover/bento:opacity-100 transition-opacity duration-300">
              <div className="flex justify-center pb-12">
          ...
          {/* PLAYER CARD */}
          <div className="mt-6 lg:col-span-2 flex items-center h-48 w-full relative lg:opacity-60 group-hover/bento:opacity-100 transition-opacity duration-500">
          ...
          {createCursorFollower(
            ...
            <div className="lg:opacity-60 group-hover/bento:opacity-100 transition-opacity duration-300 flex items-center size-full">
              <div className="relative text-3xl font-syne font-bold text-center leading-snug text-primary-700">Elegant Cards</div>
            </div>
          )}

          {/* RNAK CARDS */}
          <div className="mt-6 lg:col-span-2 flex items-center relative pb-14 lg:opacity-60 group-hover/bento:opacity-100 transition-opacity duration-300">
