...
const IconSun: FC<IconSunProps> = ({ className, fill = false, duotone = true, width = '1.5' }) => {
    return (
        <>
            {!fill ? (
                <svg fill="none" className={className} width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="12" cy="12" r="5" stroke="currentColor" strokeWidth={width} />
                    <path d="M12 2V4" stroke="currentColor" strokeWidth={width} strokeLinecap="round" />
                    <path d="M12 20V22" stroke="currentColor" strokeWidth={width} strokeLinecap="round" />
                    <path d="M4 12L2 12" stroke="currentColor" strokeWidth={width} strokeLinecap="round" />
                    <path d="M22 12L20 12" stroke="currentColor" strokeWidth={width} strokeLinecap="round" />
                    <path opacity={duotone ? '0.5' : '1'} d="M19.7778 4.22266L17.5558 6.25424" stroke="currentColor" strokeWidth={width} strokeLinecap="round" />
                    <path opacity={duotone ? '0.5' : '1'} d="M4.22217 4.22266L6.44418 6.25424" stroke="currentColor" strokeWidth={width} strokeLinecap="round" />
                    <path opacity={duotone ? '0.5' : '1'} d="M6.44434 17.5547L4.22211 19.7769" stroke="currentColor" strokeWidth={width} strokeLinecap="round" />
                    <path opacity={duotone ? '0.5' : '1'} d="M19.7778 19.7773L17.5558 17.5551" stroke="currentColor" strokeWidth={width} strokeLinecap="round" />
                </svg>
            ) : (
