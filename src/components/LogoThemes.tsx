...
const LogoThemes: React.FC<LogoThemesProps> = ({ themeName, className }) => {
  const { currentTheme, theme, setTheme } = useTheme();
  useEffect(() => {
    setTheme(themeName); // Set the theme when themeName changes
  }, [themeName, setTheme]);

  return (
    <ThemeProvider>
      <svg className={`mivator_main_logo ${className}`} viewBox="0 0 350 350">
        <g className="mivator" transform="translate(-75, -75)">
          <path
            style={{ fill: `var(--${themeName})` }}
          ...
          />
          <path
            style={{ fill: `var(--${themeName}-1200)` }}
            d="M250.1,397.1c-95.1-27.2-128-77.9-128-77.9c-19.9-97.3-1.9-208.8-1.9-208.8l45.8,51.8
				c35.2-38.4,84.1-59.4,84.1-59.4s47.4,20.5,82.6,58.9l46.3-51.4c0,0,19,111.5-0.9,208.8C378.1,319.2,345.3,369.9,250.1,397.1
				L250.1,397.1z"
          />
          <path
            style={{ fill: `var(--${themeName}-1100)` }}
            d="M329.5,170.6
          ...
          <g id="m_overlay">
            <path
              style={{ fill: `var(--${themeName}-1000)`, opacity: 0.7 }}
